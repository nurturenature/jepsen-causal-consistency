...
ElectricSQL shows no causal violations, exhibits atomic transactions, and strongly converges at low transaction rates over short periods of time.

As the rate and total number of transactions increase, replication stops on an increasing number of nodes and there are no causal or atomic transaction violations but they never converge.
